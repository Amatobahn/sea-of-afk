from gergcob.utilities import is_linux, is_macos, is_windows
...
class WindowController:
    ...
    def load_os_module():
        if is_linux():
            from gergcob.window_controllers.linux_window_controller import LinuxWindowController
            return LinuxWindowController
        elif is_macos():
            pass  # to be implemented
        elif is_windows():
            from gergcob.window_controllers.win32_window_controller import Win32WindowController
